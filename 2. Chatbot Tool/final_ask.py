...
def get_pdf_text(pdf_path):
    """Reads text from a PDF file located at the given path."""
    documents = ""
...
def main():
    ...
    image_url = "https://i2.wp.com/files.123freevectors.com/wp-content/original/202631-plain-light-color-background-graphic.jpg?w=420"  # Replace with your image URL
    ...
    with st.sidebar:
        ...
        if option=="Insurance":
            ...
            pdf_path = st.file_uploader("Upload your PDF Files", accept_multiple_files=True)
