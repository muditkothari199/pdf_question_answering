...
def details_pdf(text,doc_type,policy_type,str1):
    match doc_type:
        ...
        case 'Audit':
            ...
            return new_name
        case 'Billing':
            # bill=query_cohere_api(truncate_text(text), "what is the description:?")
        ...
        case 'Certificate Request':
            ...
            return new_name 
        case 'Claim':
            # Claim= query_cohere_api(truncate_text(text), "what is the claim description:?")
            new_name = f"{str1} {policy_type}-Policy-{doc_type}.pdf"
            return new_name
        case 'Claim Correspondence':
            # Claim=query_cohere_api(truncate_text(text), "what is the details:?")
            new_name = f"{str1} {policy_type}-Policy-{doc_type}-EMAIL COMM .pdf"
            return new_name
        case 'Correspondence':
            # Correspondence=query_cohere_api(truncate_text(text), "what is the details:?")
            new_name = f"{str1} {policy_type}-Policy-{doc_type}-EMAIL COMM.pdf"
            return new_name
        ...
        case 'Driver Exclusion':
            ...
            return new_name
        case 'Endorsement':
            # Endorsement=query_cohere_api(truncate_text(text), "what is the description:?")
            new_name = f"{str1} {policy_type}-Policy-{doc_type}.pdf"
            return new_name
        case 'Endorsement Request':
            # Request= query_cohere_api(truncate_text(text), "what is the description:?")
            new_name = f"{str1} {policy_type}-Policy-{doc_type}.pdf"
            return new_name
        case 'Invoice':
        ...
        case 'Loss Run':
            ...
            return new_name
        # case 'Loss Run Request':
        #     return "It is a vowel"
        case 'Lost Policy Release':
            new_name = f"{str1} {policy_type}-Policy-{doc_type}.pdf"
            return new_name
        case 'Non-Renewal':
            dc=query_cohere_api(truncate_text(text), "what is the carrier name:?")
        ...
        #     return "It is a vowel"
        # case 'Policy Rewrite':
        #     return query_cohere_api(truncate_text(text), "what is the carrier name and effective date:?")
        ...
        #     return query_cohere_api(truncate_text(text), "what is the carrier name:?")
        case 'Subjectivities':
            new_name = f"{str1} {policy_type}-Policy-{doc_type}.pdf"
            return new_name
        case 'Underwriting Info':
            new_name = f"{str1} {policy_type}-Policy-{doc_type}.pdf"
            return new_name
        case _:
